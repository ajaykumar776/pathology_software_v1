...
<div class="container-fluid">
		<ul class="nav navbar-nav navbar-center">
			...
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu">
					<a href="add_book.php" class="dropdown-item">Add New Paitents</a>
					<a href="manage_book.php" class="dropdown-item">Manage patients</a>
				</div>
			</li>
			<li class="nav-item">
				<a href="issue_book.php" class="nav-link">Generate Report</a>
			</li>
		</ul>
	</div>
</nav>
